    ...
    <div class="desktop-addresslist clearfix ng-scope" ng-hide="addressLoading">
        ...
        <div class="desktop-addressblock ng-scope" ng-repeat="address in userAddresses">
            <div class="desktop-addressblock-buttons">
                ...
                <button class="desktop-addressblock-button" id="{{$v['id']}}" ng-click="showMask = true">删除</button></div>
            ...
            $('.edit').on('click',function () {
                 ...
                 $.post('/home/person/editsite',{'_token':'{{csrf_token()}}','id':id},function(data){
                    ...
                    {{--layer.open({--}}
                        ...
                        {{--skin: 'layui-layer-rim', //加上边框--}}
                        {{--area: ['800px', '600px'], //宽高--}}
                        {{--content: '<h2>  　<h2><h1 style="margin:10px">修改地址 <h1><h3>  　<h3><form action="/home/order/updatesite" method="post" ><input type="hidden" name="uid" value = "1">{{csrf_field()}}<div class="addressform"><div><div class="addressformfield"><label>姓名</label><input placeholder="请输入您的姓名" name ="name" value="{{$data['addrs'][0]['name']}}"/> <div class="addressformfield-hint"><span></span></div></div><div class="addressformfield sexfield"><label>性别</label><div>  <input value="1" name="sex" id="sexfield-1-male" type="radio" checked = "checked" /><label for="sexfield-1-male">先生</label><input value="2" name="sex" id="sexfield-1-female" type="radio" /><label for="sexfield-1-female">女士</label> </div><div class="addressformfield-hint"><span></span></div></div> <div class="addressformfield addressfield"><label>位置</label> <img src="data:image/png;base64," /><input placeholder="请输入小区、大厦或学校" name = "addr" value="{{$data['addrs'][0]['addr']}}"   /> <div class="address-suggestlist"><ul></ul></div><div class="addressformfield-hint"><span></span></div><div style="display: none;" class="addressform-tip"> <p><span>没找到你的地址？</span><a style="display: none;">去地图看看吧！</a></p><p>请尝试只输入小区、大厦或学校看看。</p><div class="arrow"></div></div></div><div class="addressformfield"><label>所属商圈</label><select name="areaid"><option value="0">请选择</option>@foreach($data['areas'] as $v)<option value="{{$v->id}}">{{$v->name}}</option> @endforeach</select><div class="addressformfield-hint"><span></span></div></div><div class="addressformfield phonefield"><label>手机号</label><input placeholder="请输入您的手机号" name = "phone" value="{{$data['addrs'][0]['phone']}}" /></div><div style="display: none;" class="addressformfield phonebkfield"><label></label><input placeholder="固话、手机短号" /><button>删除</button><div class="addressformfield-hint"><span></span> </div> </div> </div><div class="addressform-buttons"><button id = "saveBtn">保存</button></div></div></form>'--}}
                        {{--content:''--}}
                    {{--});--}}
                ...
                layer.open({
                    ...
                    skin: 'layui-layer-rim', //加上边框
                    area: ['800px', '600px'], //宽高
                    {{--content: '<h2>  　<h2><h1 style="margin:10px">修改地址 {{data }}<h1><h3>  　<h3><form action="/home/order/updatesite" method="post" ><input type="hidden" name="uid" value = "1">{{csrf_field()}}<div class="addressform"><div><div class="addressformfield"><label>姓名</label><input placeholder="请输入您的姓名" name ="name" value="{{$data['addrs'][0]['name']}}"/> <div class="addressformfield-hint"><span></span></div></div><div class="addressformfield sexfield"><label>性别</label><div>  <input value="1" name="sex" id="sexfield-1-male" type="radio" checked = "checked" /><label for="sexfield-1-male">先生</label><input value="2" name="sex" id="sexfield-1-female" type="radio" /><label for="sexfield-1-female">女士</label> </div><div class="addressformfield-hint"><span></span></div></div> <div class="addressformfield addressfield"><label>位置</label> <img src="data:image/png;base64," /><input placeholder="请输入小区、大厦或学校" name = "addr" value="{{$data['addrs'][0]['addr']}}"   /> <div class="address-suggestlist"><ul></ul></div><div class="addressformfield-hint"><span></span></div><div style="display: none;" class="addressform-tip"> <p><span>没找到你的地址？</span><a style="display: none;">去地图看看吧！</a></p><p>请尝试只输入小区、大厦或学校看看。</p><div class="arrow"></div></div></div><div class="addressformfield"><label>所属商圈</label><select name="areaid"><option value="0">请选择</option>@foreach($data['areas'] as $v)<option value="{{$v->id}}">{{$v->name}}</option> @endforeach</select><div class="addressformfield-hint"><span></span></div></div><div class="addressformfield phonefield"><label>手机号</label><input placeholder="请输入您的手机号" name = "phone" value="{{$data['addrs'][0]['phone']}}" /></div><div style="display: none;" class="addressformfield phonebkfield"><label></label><input placeholder="固话、手机短号" /><button>删除</button><div class="addressformfield-hint"><span></span> </div> </div> </div><div class="addressform-buttons"><button id = "saveBtn">保存</button></div></div></form>'--}}
                    content:''
                });
            });
