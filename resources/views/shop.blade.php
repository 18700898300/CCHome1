...
<html ng-app="eleme" perf-error="desktop/" class="ng-scope">
  ...
  <head>
    ...
    <link href="{{asset('/a/css/vendor.eb86f5.css')}}" rel="stylesheet">
    <link href="{{asset('/a/css/main.301d40.css')}}" rel="stylesheet">
    <!--[if lte IE 8]>
      <script>window.location.href = 'https://h.ele.me/activities/landing';</script>
    <![endif]-->
    <script src="{{asset('/a/elm/api')}}" data-ref="API_CONFIG"></script>
    <script src="{{asset('/a/js/perf.js')}}" type="text/javascript"></script>
    <script src="{{asset('/a/js/vendor.6b3834.js')}}" type="text/javascript"></script>
    <script src="{{asset('/a/js/222.js')}}" type="text/javascript"></script>
    <!--<base href="/">s-->
    <base href=".">
    ...
    <meta name="keywords" content="田老师红烧肉（怀柔青春路店）外卖，田老师红烧肉（怀柔青春路店）菜单，田老师红烧肉（怀柔青春路店）电话"></head>
        ...
        <header class="topbar shoptopbar" role="navigation" ng-class="{shoptopbar: state.type === &#39;shop&#39;}">
          <div class="container clearfix">
            ...
            <nav class="topbar-nav">
              ...
              <a href="https://www.ele.me/support/rules/default" hardjump="" class="topbar-nav-link" target="_blank">规则中心</a>
              <div class="topbar-nav-link">
                ...
                <div class="dropbox topbar-mobile-dropbox">
                  ...
                  <img src="{{asset('/a/elm/appqc.95e532.png')}}" class="topbar-nav-qrcode" alt="扫一扫下载饿了么手机 App"></div>
              </div>
              <div topbar-profilebox="">
                <div class="topbar-profilebox">
                  ...
                  <span ng-show="!$root.user.username" class="">
                    <a ng-href="//h5.ele.me//login/#redirect=https%3A%2F%2Fwww.ele.me%2Fshop%2F1195106" target="_blank" href="https://h5.ele.me//login/#redirect=https%3A%2F%2Fwww.ele.me%2Fshop%2F1195106">登录/注册</a></span>
          ...
          <div class="toolbar-btn icon-QR-code">
            <div class="dropbox toolbar-tabs-dropbox">
              <a href="http://static11.elemecdn.com/eleme/desktop/mobile/index.html" target="_blank">
                <img src="{{asset('/a/elm/appqc.95e532.png')}}" alt="下载手机应用">
                <p>下载手机应用</p>
    ...
    <div ng-view="" role="main" class="ng-scope">
      <div class="shopguide ng-isolate-scope" shop-guide="" data="shop" isdisabled="shop.disabled">
        <div class="container" ng-show="shop" itemscope="" itemtype="http://schema.org/Restaurant">
          <div class="shopguide-info">
            ...
            <img ng-src="//fuss10.elemecdn.com/3/bf/43ba71d180d43fb084348a40a428fjpeg.jpeg?imageMogr2/thumbnail/95x95/format/webp/quality/85" alt="田老师红烧肉（怀柔青春路店）" itemprop="image" src="{{asset('/a/elm/43ba71d180d43fb084348a40a428fjpeg.jpeg')}}">
              ...
              <ul>
                ...
                <li class="shopguide-extra-item shopguide-extra-compete ng-scope" ng-if="shopRatingScore">
                  <div itemscope="" itemprop="aggregateRating" itemtype="http://schema.org/AggregateRating">
                    <h2 class="color-stress ng-binding" itemprop="ratingValue">4.3</h2>
                    ...
                    <p>综合评价
                      ...
                      <span class="color-stress ng-binding ng-scope" ng-if="shopRatingScore.compare_rating">62.1%</span>
                      <!-- end ngIf: shopRatingScore.compare_rating --></p>
                  </div>
                  <div>
                    <p>服务态度
                      <div class="starrating icon-star ng-isolate-scope" title="评分4.3分" rate-star="" rating="shopRatingScore.service_score">
                        <span class="icon-star" ng-style="{ width: (rating * 20) + &#39;%&#39; }" style="width: 86.2426%;"></span></div>
                      <span class="color-stress ng-binding">4.3分</span></p>
                    <p>菜品评价
                      <div class="starrating icon-star ng-isolate-scope" title="评分4.3分" rate-star="" rating="shopRatingScore.food_score">
                        <span class="icon-star" ng-style="{ width: (rating * 20) + &#39;%&#39; }" style="width: 86.9696%;"></span></div>
                      <span class="color-stress ng-binding">4.3分</span></p>
                  </div>
                </li>
          ...
          <a class="shopguide-favor" href="javascript:" ng-click="favor()">
            ...
            <!-- ngIf: isFavorShop -->
            <!-- ngIf: !isFavorShop -->
            <span ng-if="!isFavorShop" class="ng-scope">收藏</span>
            <!-- end ngIf: !isFavorShop --></a>
        </div>
      </div>
      <div shop-nav="" data="shop" filter-data="shop.filter" display-type="shop.displayType" shop-action="shopAction" class="ng-scope ng-isolate-scope">
        <div class="shopnav">
          <div class="container clearfix">
            <div class="shopnav-left">
              <a class="shopnav-tab active" href="https://www.ele.me/shop/1195106" ng-class="{active: shop.tab === &#39;index&#39;}">所有商品</a>
              <a class="shopnav-tab" href="https://www.ele.me/shop/1195106/rate" ng-class="{active: shop.tab === &#39;rate&#39;}">评价</a>
              <a class="shopnav-tab" href="https://www.ele.me/shop/1195106/info" ng-class="{active: shop.tab === &#39;info&#39;}">商家资质</a>
              <!-- ngIf: shopAction===' menu' -->
              <span class="shopnav-filter ng-scope" ng-if="shopAction === &#39;menu&#39;">
                <a href="javascript:" ng-click="filter(&#39;default&#39;)" ng-class="{active: filterData === &#39;default&#39;}" class="active">默认排序</a>
                <a href="javascript:" ng-click="filter(&#39;-rating&#39;)" ng-class="{active: filterData === &#39;-rating&#39;}">评分
                  <i class="icon-uniE02D"></i></a>
                <a href="javascript:" ng-click="filter(&#39;-month_sales&#39;)" ng-class="{active: filterData === &#39;-month_sales&#39;}">销量
                  <i class="icon-uniE02D"></i></a>
                <a href="javascript:" ng-click="filter(&#39;-price&#39;)" ng-class="{active: filterData === &#39;-price&#39; || filterData === &#39;price&#39;}">价格
                  <i class="icon-uniE02D" ng-hide="filterData === &#39;price&#39;"></i>
                  <i class="icon-uniE02C ng-hide" ng-show="filterData === &#39;price&#39;"></i>
                </a>
                <span>
                  <a class="shopnav-filter-display icon-grid active" href="javascript:" title="以网格形式显示菜单" ng-click="changeDisplayType(&#39;grid&#39;)" ng-class="{active: displayType === &#39;grid&#39;}"></a>
              ...
              <!-- end ngIf: shopAction===' menu' --></div>
            {{--<div class="shopnav-search">--}}
              {{--<form class="place-search ng-pristine ng-valid" role="search" ng-submit="search()">--}}
                {{--<button class="place-search-btn icon-search" ubt-click="403" ng-attr-ubt-data-keyword="{{searchText}}" title="搜索商家或美食" ubt-data-keyword=""></button>--}}
                {{--<label for="globalsearch">搜索商家或美食</label>--}}
                {{--<input id="globalsearch" class="place-search-input ng-pristine ng-valid" ng-model="searchText" autocomplete="" placeholder="搜索商家,美食..."></form>--}}
            {{--</div>--}}
          </div>
        </div>
      </div>
      <div class="shopmain clearfix container ng-scope">
        ...
        <div ng-if="shopAction === &#39;menu&#39;" shop-menu="" shop-cache="shopCache" filter-data="shop.filter" display-type="shop.displayType" class="shopmenu ng-isolate-scope" perf-click="desktop/201">
          <div class="loading ng-binding ng-isolate-scope ng-hide" loading="" ng-show="loading">
            <!-- ngIf: type==='profile' -->
            <img ng-if="type===&#39;profile&#39;" src="{{asset('/a/elm/profile-loading.4984fa.gif')}}" alt="正在加载" class="ng-scope">
          ...
          <div ng-show="!loading" class="shopmenu-main grid" ng-class="{grid: displayType === &#39;grid&#39;, list: displayType === &#39;list&#39;}">
            ...
            <div ng-if="filterData === &#39;default&#39; &amp;&amp; !searchEnv" class="ng-scope">
              ...
              <div class="shopmenu-list clearfix ng-scope" ng-repeat="category in categorys">
                ...
                <div class="shopmenu-food ng-isolate-scope" ng-class="{noimg: !food.image_path}" id="626104148" ng-repeat="food in category.foods" shop-menu-item="" food="food" shop="shopCache">
                  <!-- ngIf: food.image_path -->
                  <span class="col-1 ng-scope" ng-if="food.image_path">
                    <a href="javascript:" ng-click="showInfo(food)">
                      <img ng-src="//fuss10.elemecdn.com/b/c3/30a59110422cb0dcb4cd65571315cjpeg.jpeg?imageMogr2/thumbnail/100x100/format/webp/quality/85" alt="什锦蘑菇饭的图片" src="{{asset('/a/elm/30a59110422cb0dcb4cd65571315cjpeg.jpeg')}}"></a>
                  </span>
                  <!-- end ngIf: food.image_path -->
                  <div class="col-2 shopmenu-food-main">
                    <h3 class="shopmenu-food-name ui-ellipsis ng-binding">什锦蘑菇饭</h3>
                    <p class="color-mute ui-ellipsis ng-binding" tooltip="什锦蘑菇饭">什锦蘑菇饭</p>
                    <p>
                      <div class="starrating icon-star ng-isolate-scope" title="评分4.0分" rate-star="" rating="food.rating">
                        <span class="icon-star" ng-style="{ width: (rating * 20) + &#39;%&#39; }" style="width: 80%;"></span>
                      </div>
                      <span class="color-mute ng-binding">(1)</span>
                      <span class="color-mute ng-binding">月售13份</span></p>
                  </div>
                ...
                <!-- end ngRepeat: food in category.foods -->
                <div class="shopmenu-food ng-isolate-scope" ng-class="{noimg: !food.image_path}" id="626104158" ng-repeat="food in category.foods" shop-menu-item="" food="food" shop="shopCache">
                  <!-- ngIf: food.image_path -->
                  <span class="col-1 ng-scope" ng-if="food.image_path">
                    <a href="javascript:" ng-click="showInfo(food)">
                      <img ng-src="//fuss10.elemecdn.com/9/c7/49d2ed6f7a0fb5ec144d9d204ec96jpeg.jpeg?imageMogr2/thumbnail/100x100/format/webp/quality/85" alt="宫爆鸡丁饭的图片" src="{{asset('/a/elm/49d2ed6f7a0fb5ec144d9d204ec96jpeg.jpeg')}}"></a>
                  </span>
                  <!-- end ngIf: food.image_path -->
                  <div class="col-2 shopmenu-food-main">
                    <h3 class="shopmenu-food-name ui-ellipsis ng-binding">宫爆鸡丁饭</h3>
                    <p class="color-mute ui-ellipsis ng-binding" tooltip="宫爆鸡丁饭">宫爆鸡丁饭</p>
                    <p>
                      <div class="starrating icon-star ng-isolate-scope" title="评分4.6分" rate-star="" rating="food.rating">
                        <span class="icon-star" ng-style="{ width: (rating * 20) + &#39;%&#39; }" style="width: 91.4%;"></span>
                      </div>
                      <span class="color-mute ng-binding">(7)</span>
                      <span class="color-mute ng-binding">月售44份</span></p>
                  </div>
                  <span class="col-3 shopmenu-food-price color-stress ng-binding">16
                    <small class="ng-binding"></small></span>
                  <span class="col-4">
                ...
                <!-- end ngRepeat: food in category.foods -->
                <div class="shopmenu-food ng-isolate-scope" ng-class="{noimg: !food.image_path}" id="626099851" ng-repeat="food in category.foods" shop-menu-item="" food="food" shop="shopCache">
                  <!-- ngIf: food.image_path -->
                  <span class="col-1 ng-scope" ng-if="food.image_path">
                    <a href="javascript:" ng-click="showInfo(food)">
                      <img ng-src="//fuss10.elemecdn.com/2/63/ebb732c194773c316b9c265e17c16jpeg.jpeg?imageMogr2/thumbnail/100x100/format/webp/quality/85" alt="香菇鸡腿饭的图片" src="{{asset('/a/elm/ebb732c194773c316b9c265e17c16jpeg.jpeg')}}"></a>
                  </span>
                  <!-- end ngIf: food.image_path -->
                  <div class="col-2 shopmenu-food-main">
                    <h3 class="shopmenu-food-name ui-ellipsis ng-binding">香菇鸡腿饭</h3>
                    <p class="color-mute ui-ellipsis ng-binding" tooltip="香菇鸡腿饭">香菇鸡腿饭</p>
                    <p>
                      <div class="starrating icon-star ng-isolate-scope" title="评分4.2分" rate-star="" rating="food.rating">
                        <span class="icon-star" ng-style="{ width: (rating * 20) + &#39;%&#39; }" style="width: 83.4%;"></span>
                      </div>
                ...
                <!-- end ngRepeat: food in category.foods -->
                <div class="shopmenu-food ng-isolate-scope" ng-class="{noimg: !food.image_path}" id="626106142" ng-repeat="food in category.foods" shop-menu-item="" food="food" shop="shopCache">
                  <!-- ngIf: food.image_path -->
                  <span class="col-1 ng-scope" ng-if="food.image_path">
                    <a href="javascript:" ng-click="showInfo(food)">
                      <img ng-src="//fuss10.elemecdn.com/c/00/5c6311481ca313c555309cb33b5eejpeg.jpeg?imageMogr2/thumbnail/100x100/format/webp/quality/85" alt="豆角焖面的图片" src="{{asset('/a/elm/5c6311481ca313c555309cb33b5eejpeg.jpeg')}}"></a>
                  </span>
                  <!-- end ngIf: food.image_path -->
                  <div class="col-2 shopmenu-food-main">
                    <h3 class="shopmenu-food-name ui-ellipsis ng-binding">豆角焖面</h3>
                    <p class="color-mute ui-ellipsis ng-binding" tooltip="豆角焖面">豆角焖面</p>
                    <p>
                      ...
                      <span class="color-mute ng-binding">(3)</span>
                      <span class="color-mute ng-binding">月售38份</span></p>
                  </div>
                  <span class="col-3 shopmenu-food-price color-stress ng-binding">15
                    <small class="ng-binding"></small></span>
                  <span class="col-4">
                ...
                <!-- end ngRepeat: food in category.foods -->
                <div class="shopmenu-food ng-isolate-scope" ng-class="{noimg: !food.image_path}" id="626106931" ng-repeat="food in category.foods" shop-menu-item="" food="food" shop="shopCache">
                  <!-- ngIf: food.image_path -->
                  <span class="col-1 ng-scope" ng-if="food.image_path">
                    <a href="javascript:" ng-click="showInfo(food)">
                      <img ng-src="//fuss10.elemecdn.com/2/6d/320973891fb58b91868b22880fa11jpeg.jpeg?imageMogr2/thumbnail/100x100/format/webp/quality/85" alt="麻婆豆腐饭的图片" src="{{asset('/a/elm/320973891fb58b91868b22880fa11jpeg.jpeg')}}"></a>
                  </span>
                  <!-- end ngIf: food.image_path -->
                  <div class="col-2 shopmenu-food-main">
                    <h3 class="shopmenu-food-name ui-ellipsis ng-binding">麻婆豆腐饭</h3>
                    <p class="color-mute ui-ellipsis ng-binding" tooltip="麻婆豆腐饭">麻婆豆腐饭</p>
                    <p>
                      <div class="starrating icon-star ng-isolate-scope" title="评分0.0分" rate-star="" rating="food.rating">
                        <span class="icon-star" ng-style="{ width: (rating * 20) + &#39;%&#39; }" style="width: 0%;"></span>
                      </div>
                      <span class="color-mute ng-binding">(0)</span>
                      <span class="color-mute ng-binding">月售6份</span></p>
                  </div>
                  <span class="col-3 shopmenu-food-price color-stress ng-binding">15
                    <small class="ng-binding"></small></span>
                  <span class="col-4">
                ...
                <!-- end ngRepeat: food in category.foods -->
                <div class="shopmenu-food ng-isolate-scope" ng-class="{noimg: !food.image_path}" id="626109575" ng-repeat="food in category.foods" shop-menu-item="" food="food" shop="shopCache">
                  <!-- ngIf: food.image_path -->
                  <span class="col-1 ng-scope" ng-if="food.image_path">
                    <a href="javascript:" ng-click="showInfo(food)">
                      <img ng-src="//fuss10.elemecdn.com/5/4a/6b9f70af219c94b22da8b44144933jpeg.jpeg?imageMogr2/thumbnail/100x100/format/webp/quality/85" alt="木须肉饭的图片" src="{{asset('/a/elm/6b9f70af219c94b22da8b44144933jpeg.jpeg')}}"></a>
                  </span>
                  <!-- end ngIf: food.image_path -->
                  <div class="col-2 shopmenu-food-main">
                    <h3 class="shopmenu-food-name ui-ellipsis ng-binding">木须肉饭</h3>
                    <p class="color-mute ui-ellipsis ng-binding" tooltip="木须肉饭">木须肉饭</p>
                    <p>
                      <div class="starrating icon-star ng-isolate-scope" title="评分3.8分" rate-star="" rating="food.rating">
                        <span class="icon-star" ng-style="{ width: (rating * 20) + &#39;%&#39; }" style="width: 75%;"></span>
                      </div>
                      <span class="color-mute ng-binding">(4)</span>
                      <span class="color-mute ng-binding">月售15份</span></p>
                  </div>
                  <span class="col-3 shopmenu-food-price color-stress ng-binding">15
                    <small class="ng-binding"></small></span>
                  <span class="col-4">
                ...
                <!-- end ngRepeat: food in category.foods -->
                <div class="shopmenu-food ng-isolate-scope" ng-class="{noimg: !food.image_path}" id="626110596" ng-repeat="food in category.foods" shop-menu-item="" food="food" shop="shopCache">
                  <!-- ngIf: food.image_path -->
                  <span class="col-1 ng-scope" ng-if="food.image_path">
                    <a href="javascript:" ng-click="showInfo(food)">
                      <img ng-src="//fuss10.elemecdn.com/8/fe/f752c547efbd4b7b97ac12841d914jpeg.jpeg?imageMogr2/thumbnail/100x100/format/webp/quality/85" alt="无骨咖喱鸡饭的图片" src="{{asset('/a/elm/f752c547efbd4b7b97ac12841d914jpeg.jpeg')}}"></a>
                  </span>
                  <!-- end ngIf: food.image_path -->
                  <div class="col-2 shopmenu-food-main">
                    <h3 class="shopmenu-food-name ui-ellipsis ng-binding">无骨咖喱鸡饭</h3>
                    <p class="color-mute ui-ellipsis ng-binding" tooltip="无骨咖喱鸡饭">无骨咖喱鸡饭</p>
                    <p>
                      <div class="starrating icon-star ng-isolate-scope" title="评分4.2分" rate-star="" rating="food.rating">
                        <span class="icon-star" ng-style="{ width: (rating * 20) + &#39;%&#39; }" style="width: 84%;"></span>
                      </div>
                      <span class="color-mute ng-binding">(10)</span>
                      <span class="color-mute ng-binding">月售54份</span></p>
                  </div>
                  <span class="col-3 shopmenu-food-price color-stress ng-binding">16
                    <small class="ng-binding"></small></span>
                  <span class="col-4">
                ...
                <!-- end ngRepeat: food in category.foods -->
                <div class="shopmenu-food ng-isolate-scope" ng-class="{noimg: !food.image_path}" id="626114127" ng-repeat="food in category.foods" shop-menu-item="" food="food" shop="shopCache">
                  <!-- ngIf: food.image_path -->
                  <span class="col-1 ng-scope" ng-if="food.image_path">
                    <a href="javascript:" ng-click="showInfo(food)">
                      <img ng-src="//fuss10.elemecdn.com/9/a8/e045ea107fcd8f6a812ea60697ec8jpeg.jpeg?imageMogr2/thumbnail/100x100/format/webp/quality/85" alt="香锅焖面的图片" src="{{asset('/a/elm/e045ea107fcd8f6a812ea60697ec8jpeg.jpeg')}}"></a>
                  </span>
                  <!-- end ngIf: food.image_path -->
                  <div class="col-2 shopmenu-food-main">
                    <h3 class="shopmenu-food-name ui-ellipsis ng-binding">香锅焖面</h3>
                    <p class="color-mute ui-ellipsis ng-binding" tooltip="香锅焖面">香锅焖面</p>
                    <p>
                      <div class="starrating icon-star ng-isolate-scope" title="评分4.4分" rate-star="" rating="food.rating">
                        <span class="icon-star" ng-style="{ width: (rating * 20) + &#39;%&#39; }" style="width: 88%;"></span>
                      </div>
                      <span class="color-mute ng-binding">(20)</span>
                      <span class="color-mute ng-binding">月售91份</span></p>
                  </div>
                  <span class="col-3 shopmenu-food-price color-stress ng-binding">17
                    <small class="ng-binding"></small></span>
                  <span class="col-4">
                    <div shop-cartbutton="" food="food" ng-hide="shop.id == &#39;656683&#39;" class="ng-isolate-scope">
                      <!-- ngIf: !menuFood.hasSpec -->
                ...
                <!-- end ngRepeat: food in category.foods -->
                <div class="shopmenu-food ng-isolate-scope" ng-class="{noimg: !food.image_path}" id="626112465" ng-repeat="food in category.foods" shop-menu-item="" food="food" shop="shopCache">
                  <!-- ngIf: food.image_path -->
                  <span class="col-1 ng-scope" ng-if="food.image_path">
                    <a href="javascript:" ng-click="showInfo(food)">
                      <img ng-src="//fuss10.elemecdn.com/7/b1/ac65d1ee927a0aae3ffea5deb2f4ajpeg.jpeg?imageMogr2/thumbnail/100x100/format/webp/quality/85" alt="鱼香肉丝饭的图片" src="{{asset('/a/elm/ac65d1ee927a0aae3ffea5deb2f4ajpeg.jpeg')}}"></a>
                  </span>
                  <!-- end ngIf: food.image_path -->
                  <div class="col-2 shopmenu-food-main">
                ...
                <!-- end ngRepeat: food in category.foods -->
                <div class="shopmenu-food ng-isolate-scope" ng-class="{noimg: !food.image_path}" id="626136638" ng-repeat="food in category.foods" shop-menu-item="" food="food" shop="shopCache">
                  <!-- ngIf: food.image_path -->
                  <span class="col-1 ng-scope" ng-if="food.image_path">
                    <a href="javascript:" ng-click="showInfo(food)">
                      <img ng-src="//fuss10.elemecdn.com/9/7b/9aaecdea446ab4bff8a7aee6fe1fdjpeg.jpeg?imageMogr2/thumbnail/100x100/format/webp/quality/85" alt="烧茄子饭的图片" src="{{asset('/a/elm/9aaecdea446ab4bff8a7aee6fe1fdjpeg.jpeg')}}"></a>
                  </span>
                  <!-- end ngIf: food.image_path -->
                  <div class="col-2 shopmenu-food-main">
                    <h3 class="shopmenu-food-name ui-ellipsis ng-binding">烧茄子饭</h3>
                    <p class="color-mute ui-ellipsis ng-binding" tooltip="烧茄子饭">烧茄子饭</p>
                    <p>
                      <div class="starrating icon-star ng-isolate-scope" title="评分4.0分" rate-star="" rating="food.rating">
                        <span class="icon-star" ng-style="{ width: (rating * 20) + &#39;%&#39; }" style="width: 80%;"></span>
                      </div>
                      <span class="color-mute ng-binding">(4)</span>
                      <span class="color-mute ng-binding">月售27份</span></p>
                  </div>
                  <span class="col-3 shopmenu-food-price color-stress ng-binding">15
                    <small class="ng-binding"></small></span>
                  <span class="col-4">
                ...
                <!-- end ngRepeat: food in category.foods -->
                <div class="shopmenu-food ng-isolate-scope" ng-class="{noimg: !food.image_path}" id="626134970" ng-repeat="food in category.foods" shop-menu-item="" food="food" shop="shopCache">
                  <!-- ngIf: food.image_path -->
                  <span class="col-1 ng-scope" ng-if="food.image_path">
                    <a href="javascript:" ng-click="showInfo(food)">
                      <img ng-src="//fuss10.elemecdn.com/c/03/cbf39263a0a8372f894127caa0bc7jpeg.jpeg?imageMogr2/thumbnail/100x100/format/webp/quality/85" alt="香辣笋干烧肉饭的图片" src="{{asset('/a/elm/cbf39263a0a8372f894127caa0bc7jpeg.jpeg')}}"></a>
                  </span>
                  <!-- end ngIf: food.image_path -->
                  <div class="col-2 shopmenu-food-main">
                    <h3 class="shopmenu-food-name ui-ellipsis ng-binding">香辣笋干烧肉饭</h3>
                    <p class="color-mute ui-ellipsis ng-binding" tooltip="香辣笋干烧肉饭">香辣笋干烧肉饭</p>
                    <p>
                      <div class="starrating icon-star ng-isolate-scope" title="评分4.2分" rate-star="" rating="food.rating">
                        <span class="icon-star" ng-style="{ width: (rating * 20) + &#39;%&#39; }" style="width: 83.4%;"></span>
                      </div>
                      <span class="color-mute ng-binding">(6)</span>
                      <span class="color-mute ng-binding">月售36份</span></p>
                  </div>
                  <span class="col-3 shopmenu-food-price color-stress ng-binding">17
                    <small class="ng-binding"></small></span>
                  <span class="col-4">
                ...
                <div class="shopmenu-food ng-isolate-scope" ng-class="{noimg: !food.image_path}" id="667240426" ng-repeat="food in category.foods" shop-menu-item="" food="food" shop="shopCache">
                  ...
                  <span class="col-1 ng-scope" ng-if="food.image_path">
                    <a href="javascript:" ng-click="showInfo(food)">
                      <img ng-src="//fuss10.elemecdn.com/e/e8/cc3d941aa785d2f0c603fb08a0bfcjpeg.jpeg?imageMogr2/thumbnail/100x100/format/webp/quality/85" alt="碳烧鸡饭的图片" src="{{asset('/a/elm/cc3d941aa785d2f0c603fb08a0bfcjpeg.jpeg')}}"></a>
                  </span>
                  <!-- end ngIf: food.image_path -->
                  <div class="col-2 shopmenu-food-main">
                    ...
                    <section class="iteminfo-info">
                      ...
                      <div class="iteminfo-cartitem">
                        <div class="iteminfo-price">
                          <span class="price">
                            <span class="yen">¥</span>
                            <span class="price ng-binding" ng-bind="(itemInfo.original_price || itemInfo.price) + (itemInfo.specfoods_id.length &gt; 1 ? &#39;起&#39; : &#39;&#39;)"></span>
                          </span>
                        </div>
                        <!-- ngIf: itemInfo.name --></div>
                      <div class="iteminfo-rate">
                        <!-- ngIf: ratingCount -->
                        <ul class="rategroup">
                          <!-- ngRepeat: item in ratePageContext.pageData --></ul>
            ...
            <div class="shopbulletin-section">
              ...
              <ul class="shopbulletin-supports">
                ...
                <li ng-repeat="support in shop.supports" class="ng-binding ng-scope">
                  <span ng-style="{&#39;background-color&#39;: &#39;#&#39; + support.icon_color}" class="ng-binding" style="background-color: rgb(153, 153, 153);">票</span>该商家支持开发票，开票订单金额10.0元起，请在下单时填写好发票抬头</li>
                <!-- end ngRepeat: support in shop.supports --></ul>
              <a href="javascript:" class="shopcomplaint" ng-click="testLogin()">举报商家</a></div>
              ...
              <div class="dialog-content" ng-transclude="">
                ...
                <form ng-submit="complaint()" class="ng-scope ng-pristine ng-valid">
                  <label class="complaint-field">
                    <textarea class="shopcomplaint-textarea ng-pristine ng-valid" ng-model="complaintObj.text" rows="6" cols="40"></textarea>
                  </label>
                  <div class="complaint-field">
                    <button type="submit" class="btn-primary">提交</button></div>
                </form>
              </div>
            </div>
          </div>
      ...
      <div class="sidetools" side-tools="">
        ...
        <div class="sidetools-item icon-qrcode">
          <img class="sidetools-qrcode" src="{{asset('/a/elm/appqc.95e532.png')}}" alt="扫描二维码免费下载手机App"></div>
      ...
      <div class="container clearfix">
          ...
          <div class="footer-contect-item">关注我们 :
            <div href="JavaScript:" class="icon-wechat" ubt-click="402">
              <div class="dropbox dropbox-bottom footer-contect-dropbox" ubt-visit="402">
                <img src="{{asset('/a/elm/wexinqc100@2x.393ade.png')}}" alt="微信号: elemeorder">
                <p>微信号: elemeorder</p>
                <p>饿了么网上订餐</p>
              </div>
            </div>
        ...
        <div class="footer-mobile">
          <a href="https://h.ele.me/landing" target="_blank">
            <img src="{{asset('/a/elm/appqc.95e532.png')}}" class="footer-mobile-icon" alt="扫一扫下载饿了么手机 App"></a>
        ...
        <div class="footer-police container">
          <a href="http://www.zx110.org/picp/?sn=310100103568" rel="nofollow" target="_blank">
            <img alt="已通过沪公网备案，备案号 310100103568" src="{{asset('/a/elm/picp_bg.e373b3.jpg')}}" height="30"></a>
        </div>
      </div>
    </footer>
    <footer class="footer" role="contentinfo">
