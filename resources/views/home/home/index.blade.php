...
//         })
//            alert(111);
                var s  = 'http://ccchome.oss-cn-beijing.aliyuncs.com/151228415287185a239ff80fd48.png';
            var sContent =
                "<h4 style='margin:0 0 5px 0;padding:0.2em 0'>天安门</h4>" +
                "<img style='float:right;margin:4px' id='imgDemo' src=" + s + "  width='139' height='104' title='天安门'/>" +
                "<p style='margin:0;line-height:1.5;font-size:13px;text-indent:2em'>天安门坐落在中国北京市中心,故宫的南侧,与天安门广场隔长安街相望,是清朝皇城的大门...</p>" +
                "</div>";
            var map = new BMap.Map("allmap");
            var position ="116.34232,40.076426";
            var point = new BMap.Point(position);//??????????///位置////////??????????????
