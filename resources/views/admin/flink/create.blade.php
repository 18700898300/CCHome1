...
@section('body')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/flink')}}" method="post" id = "art_form" enctype="multipart/form-data" multiple="true">
            {{csrf_field()}}
            @if (count($errors) > 0)
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="fpath" value="{{old('fpath')}}">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" size="50" id="art_thumb" name='ffpic' value="{{old('ffpic')}}"><br>
