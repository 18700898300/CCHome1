            ...
            <div class="result_content">
                ...
                @foreach($roles as $k=>$v)
                    <tr>
                        ...
                        <td class="tc">
                            <a href="{{url('admin/xtAdmin/role/auth')}}/{{$v->rid}}">授权</a>
                            <a href="{{url('admin/xtAdmin/role/'.$v->rid.'/edit')}}">修改</a>
                            <a href="javascript:;" onclick="delRole({{$v->rid}})">删除</a>
                        </td>
                    </tr>
...
//                $.get("请求服务器的路径","携带的参数", 获取执行成功后的额返回数据);
                //admin/user/1
                $.post("{{url('admin/xtAdmin/role')}}/"+id,{"_token":"{{csrf_token()}}","_method":"delete"},function(data){
//                    alert(data);
