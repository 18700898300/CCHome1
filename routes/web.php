...
//退出登录
Route::get('home/quit','IndexController@quit');
...
//显示编辑头像
Route::get('home/avatar','Home\PersonController@avatar');

Route::post('home/avatar/upload','Home\PersonController@upload');

//更改手机号
//显示更改手机号的页面
Route::get('home/changephone','Home\PersonController@changephone');
...
//地址管理
Route::get('home/address','Home\PersonController@address');


//安全中心
Route::get('home/safe','Home\PersonController@safe');
