...
<head>
    ...
    <title class="ng-binding" ng-bind="SEO.title">CCHome-网上订餐_外卖_CCHome订餐官网</title>
...
<!-- ngView:  --><div class="ng-scope" ng-view="" role="main"><div class="map ng-scope" ng-class="{mapmode: mapMode}"><div class="container mapcontainer"><div map-header="" class="map-header clearfix"><h1><a href="#" ubt-click="1433"><img src="{{$conf['logo']}}" alt="cchome" style="width:100px;height:100px"></a></h1><!-- ngIf: user.user_id --> <!-- ngIf: !user.user_id --><span class="map-header-right ng-scope" ng-if="!user.user_id"><a class="btn-security btn-sm" href="{{url('admin/merindex')}}" target="_blank" ubt-click="1432">商户店铺详情</a><a class="btn-security btn-sm" href="{{url('home/qstatus')}}" target="_blank" ubt-click="1432">开店申请状态查询</a><a href="{{asset('admin/meregisterm')}}" ng-href="//h5.ele.me/login/#redirect=https%3A%2F%2Fwww.ele.me%2Fhome%2F" target="_blank" ubt-click="1430">商户注册</a> <span>|</span> <a href="{{asset('admin/mlogin')}}" ng-href="//h5.ele.me/login/#redirect=https%3A%2F%2Fwww.ele.me%2Fhome%2F" ubt-click="1431">登录</a> <a class="btn-security btn-sm" href="{{url('home/reg')}}" target="_blank" ubt-click="1432">我要开店</a></span><!-- end ngIf: !user.user_id --></div><div map-main="" map-mode="mapMode" class="map-main ng-isolate-scope" ng-class="{mapmode: mapMode}"><h2 class="map-logo"><img src="{{$conf['logo']}}/map-logo-center.425427.svg" alt="CCHome"></h2><div class="map-navbar clearfix" ng-class="{hasuserinfo: $root.user.user_id}"><div map-city="" hide-search-result="hideSearchResult" current-city="currentCity" class="map-city ng-isolate-scope" map-mode="mapMode"><a class="mapcity-current ng-binding" ng-bind="mapCity.current.name" ng-click="mapCity.toggle($event)">北京</a><!-- ngIf: mapCity.showCities --></div><div map-search="" hide-search-result="hideSearchResult" current-city="currentCity" map-mode="mapMode" class="map-search ng-isolate-scope">
