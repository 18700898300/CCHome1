...
<div class="addressdialog-content">
    ...
    <form action="/home/order/insertsite" method="post" >
        ...
        <div>
            ...
            <div class="addressformfield sexfield">
                ...
                <div>
                    ...
                    <input value="1" name="sex" id="sexfield-1-male" type="radio" />
                    <label for="sexfield-1-male">先生</label>

                    <input value="2" name="sex" id="sexfield-1-female" type="radio"/>
