<!DOCTYPE html>
<html perf-error="desktop/" ng-app="eleme" class="ng-scope">
<head>
    <style type="text/css">
    ...
    <link rel="shortcut icon" href="{{asset('/a/elm/favicon-16x16.png')}}" type="image/png">
    <link rel="icon" href="{{asset('/a/elm/favicon-16x16.png')}}" type="image/png" sizes="16x16">
    <link rel="icon" href="{{asset('/a/elm/favicon-32x32.png')}}" type="image/png" sizes="32x32">
    <link rel="icon" href="{{asset('/a/elm/favicon.png')}}" type="image/png" sizes="96x96">
...
<div class="ng-isolate-scope" state="layoutState" ng-switch="state.type"><!-- ngSwitchWhen: checkout -->
    <header ng-switch-when="checkout" topbar-checkout="" state="state" class="carttopbar">
        <div class="carttopbar-nav container clearfix"><span class="carttopbar-nav-path">当前位置：<a
                        href="https://www.ele.me/place/wx4sp8kd8y4" class="ng-binding" ng-href="/place/wx4sp8kd8y4"
                        ng-bind="$root.place.name || $root.place.address">昌平区回龙观北回归线(回龙观东大街南)</a> <i
                        class="icon-arrow-right"></i> <a href="https://www.ele.me/shop/1195138"
                                                         class="inherit ng-binding" ng-href="/shop/1195138"
                                                         ng-bind="state.rstName"
                                                         ng-show="state.rstName">田老师红烧肉（回龙观东大街店）</a> <i
                        class="icon-arrow-right" ng-show="state.rstName"></i> 订单信息</span>
            <div topbar-profilebox="">
                <div class="topbar-profilebox"><!-- ngIf: $root.user.avatar && $root.topbarType !== 'checkout' --><img
                            src="{{asset('/a/elm/d1ee2fb385057be49be127b9c6f69jpeg.jpeg')}}" class="topbar-profilebox-avatar ng-scope"
                            ng-src="//fuss10.elemecdn.com/6/5e/d1ee2fb385057be49be127b9c6f69jpeg.jpeg?imageMogr2/thumbnail/26x26"
                            ng-if="$root.user.avatar &amp;&amp; $root.topbarType !== 'checkout'" alt="">
                    <!-- end ngIf: $root.user.avatar && $root.topbarType !== 'checkout' --> <span
                            class="topbar-profilebox-avatar icon-profile ng-hide" ng-show="!$root.user.username"></span>
                    <span class="ng-hide" ng-show="!$root.user.username"><a
                                href="https://h5.ele.me/login/#redirect=https%3A%2F%2Fwww.ele.me%2Fcart%2Fcheckout"
                                ng-href="//h5.ele.me/login/#redirect=https%3A%2F%2Fwww.ele.me%2Fcart%2Fcheckout"
                                target="_blank">登录/注册</a></span> <span class="topbar-profilebox-wrapper"
                                                                       ng-show="$root.user.username"><!-- ngIf: $root.topbarType === 'checkout' --> <span
                                class="topbar-profilebox-username ng-binding">45aa90ffc</span>
                        ...
                        <!-- end ngIf: $root.topbarType !== 'checkout' --><div
                                class="dropbox topbar-profilebox-dropbox"><a class="icon-profile"
                                                                             href="https://www.ele.me/profile"
                                                                             hardjump="">个人中心</a> <a class="icon-star"
                                                                                                     href="https://www.ele.me/profile/favor"
                                                                                                     hardjump="">我的收藏</a> <a
                                    class="icon-location" href="https://www.ele.me/profile/address" hardjump="">我的地址</a> <a
                                    class="icon-setting" href="https://www.ele.me/profile/security" hardjump="">安全设置</a> <a
                                    class="icon-logout" ng-click="logout()">退出登录</a></div></span></div>
            </div>
        </div>
    </header><!-- ngSwitchDefault:  --></div>
...
<div ng-hide="layoutState &amp;&amp; layoutState.hideSidebar" class="sidebar ng-hide" role="complementary">
    <div class="sidebar-tabs">
        <div class="toolbar-tabs-middle"><a class="toolbar-btn icon-order toolbar-close"
            ...
            <a class="toolbar-cartbtn icon-cart toolbar-open toolbar-cartbtn-shownum" template="cart"
               ng-class="{'focus': (activeTemplate === 'cart' &amp;&amp; isSidebarOpen), 'toolbar-cartbtn-shownum': foodCount.count}"
               ubt-click="390">购物车<!-- ngIf: foodCount.count --><i class="toolbar-cartnum ng-binding ng-scope"
                                                                   ng-if="foodCount.count"
                                                                   ng-bind="foodCount.count">5</i>
                <!-- end ngIf: foodCount.count --></a>
            <div class="toolbar-separator"></div>
            <a class="toolbar-btn icon-notice toolbar-open modal-hide" template="message"
            ...
            <div class="toolbar-btn icon-QR-code">
                <div class="dropbox toolbar-tabs-dropbox"><a
                            href="http://static11.elemecdn.com/eleme/desktop/mobile/index.html" target="_blank"><img
                                src="{{asset('/a/elm/appqc.95e532.png')}}" alt="下载手机应用">
                        <p>下载手机应用</p>
                        <p class="icon-QR-code-bonus">即可参加分享红包活动</p></a></div>
            </div>
            <a style="visibility: visible;" class="toolbar-btn sidebar-btn-backtop icon-top" tooltip="回到顶部" title="回到顶部"
               tooltip-placement="left"></a></div>
    </div>
...
<div class="ng-scope" ng-view="" role="main">
    ...
    <div class="container clearfix ng-scope"><!-- ngIf: loading --><!-- ngIf: !loading && nofood -->
        ...
        <div ng-if="!loading &amp;&amp; !nofood" class="checkout-cart ng-scope ng-isolate-scope" checkout-cart="cart">
            <div class="checkoutcart-container">
                <div class="checkoutcart-title"><h2>订单详情</h2><a href="https://www.ele.me/shop/1195138"
                ...
                <dl ng-if="basket.length" ng-repeat="basket in cart.vm.group" class="checkoutcart-group ng-scope">
                    ...
                    <dd class="ng-scope" ng-repeat="item in basket">
                        <div class="checkoutcart-tablerow">
                            <div class="cell itemname ng-binding" ng-bind="item.name" title="番茄蛋花汤-碗">番茄蛋花汤-碗</div>
                            <div class="cell itemquantity">
                                <button ng-click="cart.sub(item)">-</button>
                                <input class="ng-pristine ng-valid" ng-model="item.quantity"
                                       ng-change="cart.update(item)" ng-blur="cart.blur(item)">
                                <button ng-click="cart.add(item)">+</button>
                            </div>
                            <div class="cell itemtotal ng-binding"
                                 ng-bind="'¥' + (item.price * item.quantity | number:2)">¥3.00
                            </div>
                        </div>
                    </dd><!-- end ngRepeat: item in basket -->
                    <dd class="ng-scope" ng-repeat="item in basket">
                        <div class="checkoutcart-tablerow">
                            <div class="cell itemname ng-binding" ng-bind="item.name" title="单份番茄鸡蛋-个">单份番茄鸡蛋-个</div>
                            <div class="cell itemquantity">
                                <button ng-click="cart.sub(item)">-</button>
                                <input class="ng-pristine ng-valid" ng-model="item.quantity"
                                       ng-change="cart.update(item)" ng-blur="cart.blur(item)">
                            ...
                            <div class="cell itemtotal ng-binding"
                                 ng-bind="'¥' + (item.price * item.quantity | number:2)">¥7.00
                            </div>
                        </div>
                    </dd><!-- end ngRepeat: item in basket -->
                    <dd class="ng-scope" ng-repeat="item in basket">
                        <div class="checkoutcart-tablerow">
                            <div class="cell itemname ng-binding" ng-bind="item.name" title="烤肠(根)-根">烤肠(根)-根</div>
                            <div class="cell itemquantity">
                                <button ng-click="cart.sub(item)">-</button>
                                <input class="ng-pristine ng-valid" ng-model="item.quantity"
                                       ng-change="cart.update(item)" ng-blur="cart.blur(item)">
                            ...
                            <div class="cell itemtotal ng-binding"
                                 ng-bind="'¥' + (item.price * item.quantity | number:2)">¥4.00
                            </div>
                        </div>
                    </dd><!-- end ngRepeat: item in basket -->
                    <dd class="ng-scope" ng-repeat="item in basket">
                        <div class="checkoutcart-tablerow">
                            <div class="cell itemname ng-binding" ng-bind="item.name" title="单份米饭-个">单份米饭-个</div>
                            <div class="cell itemquantity">
                                <button ng-click="cart.sub(item)">-</button>
                                <input class="ng-pristine ng-valid" ng-model="item.quantity"
                                       ng-change="cart.update(item)" ng-blur="cart.blur(item)">
                            ...
                            <div class="cell itemtotal ng-binding"
                                 ng-bind="'¥' + (item.price * item.quantity | number:2)">¥2.00
                            </div>
                        </div>
                    </dd><!-- end ngRepeat: item in basket -->
                    <dd class="ng-scope" ng-repeat="item in basket">
                        <div class="checkoutcart-tablerow">
                            <div class="cell itemname ng-binding" ng-bind="item.name" title="肥牛饭-份">肥牛饭-份</div>
                            <div class="cell itemquantity">
                                <button ng-click="cart.sub(item)">-</button>
                                <input class="ng-pristine ng-valid" ng-model="item.quantity"
                                       ng-change="cart.update(item)" ng-blur="cart.blur(item)">
                            ...
                            <div class="cell itemtotal ng-binding"
                                 ng-bind="'¥' + (item.price * item.quantity | number:2)">¥17.00
                            </div>
                        </div>
                    </dd><!-- end ngRepeat: item in basket --></dl><!-- end ngIf: basket.length -->
                <!-- end ngRepeat: basket in cart.vm.group --><!-- ngIf: cart.vm.extra || cart.vm.records -->
                ...
                <div class="checkoutcart-total color-stress">¥<span class="num ng-binding"
                                                                    ng-bind="cart.vm.total | number: 2">39.50</span>
                </div>
                <div class="checkoutcart-totalextra">共 <span class="ng-binding" ng-bind="cart.pieces">5</span> 份商品
        ...
        <div ng-if="!loading &amp;&amp; !nofood" class="checkout-content ng-scope">
            <div class="checkout-select ng-isolate-scope" checkout-address="" checkout-data="checkoutData"
                 address-list="addressList" address="address" isbaisheng="isBaishengRst"><h2>收货地址 <a
                            ng-show="addressList.length" class="checkout-addaddress" ng-click="addAddress()">添加新地址</a>
            ...
            <div>
                ...
                <div class="checkout-dapp"><p class="checkout-dapp-tip">扫码下载APP<br>APP下单立享优惠</p><i
                            ...
                            class="icon-uniE029 checkout-dapp-arrow"></i> <img src="appqc.95e532.png"
    ...
    <div class="checkout-quicksubmit ng-scope ng-hide" ng-hide="checkout.submitVisable || nofood">
        <div class="container"><span class="quick-text">应付金额 <span class="yen">¥</span><span class="total ng-binding"
                                                                                             ng-bind="cartView.vm.total">39.5</span></span>
...
<footer class="footer" role="contentinfo">
    <div class="container clearfix">
        <div class="footer-link"><h3 class="footer-link-title">用户帮助</h3><a class="footer-link-item"
                                                                           href="https://www.ele.me/support/question/default"
        ...
        <div class="footer-link"><h3 class="footer-link-title">商务合作</h3><a class="footer-link-item"
                    ...
                    class="footer-link-item" href="https://www.ele.me/support/about/jiameng" target="_blank">加盟指南</a> <a
                    class="footer-link-item" href="https://www.ele.me/support/about/contact" target="_blank">市场合作</a> <a
        ...
        <div class="footer-link"><h3 class="footer-link-title">关于我们</h3><a class="footer-link-item"
                                                                           href="https://www.ele.me/support/about"
                                                                           target="_blank">饿了么介绍</a> <a
                    class="footer-link-item" href="http://jobs.ele.me/" target="_blank">加入我们</a> <a
                    class="footer-link-item" href="https://www.ele.me/support/about/contact" target="_blank">联系我们</a> <a
                    href="https://h5.ele.me/service/agreement/#HEAEDER_SHOW=1" class="footer-link-item"
                    ng-href="//h5.ele.me/service/agreement/#HEAEDER_SHOW=1" target="_blank">规则中心</a></div>
            ...
            <div class="footer-contect-item">关注我们 :
                <div href="JavaScript:" class="icon-wechat" ubt-click="402">
                    <div class="dropbox dropbox-bottom footer-contect-dropbox" ubt-visit="402"><img
                                src="wexinqc100@2x.393ade.png" alt="微信号: elemeorder">
                        <p>微信号: elemeorder</p>
                        <p>饿了么网上订餐</p></div>
                </div>
                <a href="http://e.weibo.com/elemeorder" class="icon-weibo" target="_blank"></a></div>
        </div>
        <div class="footer-mobile"><a href="https://h.ele.me/landing" target="_blank"><img src="appqc.95e532.png"
        ...
        <div class="footer-police container"><a href="http://www.zx110.org/picp/?sn=310100103568" rel="nofollow"
                                                target="_blank"><img alt="已通过沪公网备案，备案号 310100103568"
                                                                     src="{{asset('/a/elm/picp_bg.e373b3.jpg')}}" height="30"></a></div>
    </div>
</footer>
