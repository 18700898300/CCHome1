    ...
    <div ng-switch-default="" topbar-default="" state="state" class="ng-scope ng-isolate-scope">
        <header class="topbar shoptopbar" role="navigation" ng-class="{shoptopbar: state.type === &#39;shop&#39;}">
            <div class="container clearfix">
                ...
                <a href="{{url('')}}" hardjump="" class="topbar-item" ng-class="{&#39;focus&#39;: $root.locationpath[1] === &#39;order&#39;}">我的订单</a>
    ...
    <div class="shopmain clearfix container ng-scope">
        ...
        <div ng-if="shopAction === &#39;menu&#39;" shop-menu="" shop-cache="shopCache" filter-data="shop.filter" display-type="shop.displayType" class="shopmenu ng-isolate-scope" perf-click="desktop/201">
            ...
            <div ng-show="!loading &amp;&amp; !searchEnv" class="shopmenu-nav ng-isolate-scope" sticky="" sticky-class="sticky" sticky-body-class="shopmenu-nav-sticky" sticky-fn="shopNavSticky">
                ...
                <a href="#{{$vv->name}}" ng-repeat="category in categorys" ng-onclick="scrollTo()" ng-class="{active: currentCategory.id === category.id}" class="ng-binding ng-scope">{{$vv->name}}</a>
                @endforeach
                    ...
                    <script>
                        ...
                        function info(food){
                            layer.open({
                                ...
                                content: '<div style="padding:20px;position:relative"><div style="float:left"><img style="width:300px;height:300px" src="{{asset($v->fpic)}}"></div><div style="float:left"><h5>ewrewrw</h5></div></div>'
                            })
                        }
