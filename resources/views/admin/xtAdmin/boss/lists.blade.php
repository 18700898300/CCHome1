...
@section('body')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="#">商户模块</a> &raquo; 商户列表
    </div>
    <!--面包屑导航 结束-->

    <!--结果页快捷搜索框 开始-->
    <div class="search_wrap">
        <form action="{{url('admin/xtAdmin/boss/lists')}}" method="get">
        ...
        <div class="result_wrap">
            <div class="result_content">
                ...
                <div class="page_list">
                    ...
                    {!! $boss->appends($request->all())->render() !!}
                </div>
...
//                $.get("请求服务器的路径","携带的参数", 获取执行成功后的额返回数据);
                //admin/user/1
                $.post("{{url('admin/xtAdmin/boss/del')}}/"+id,{"_token":"{{csrf_token()}}"},function(data){
//                alert(data);
