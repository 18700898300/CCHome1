...
@section('body')
    ...
    <div class="profile-panelcontent" ng-transclude="">
        <div class="profileinfo ng-scope">
            <p class="profileinfo-item"><span class="profileinfo-label">头像</span> <span class="profileinfo-face"><img  alt="eb6d4037dca" src="{{$users['avatar']}}" /> <a class="profileinfo-facedit" href="{{asset('/home/avatar')}}">编辑头像</a></span></p>
